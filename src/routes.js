...
import AddCoulmns from "./views/AddColumns/AddCoulmns";
import FCoulmn from "./views/AddColumns/FCoulmn";
import SCoulmn from "./views/AddColumns/SCoulmn";
import TCoulmn from "./views/AddColumns/TCoulmn";
...
const Sizes = React.lazy(() => import("./views/pages/sizes/Sizes"));
...
const routes = [
  ...
  { path: "/secondlayout", name: "SecondLayout", element: SecondLayout },
  { path: "/addcoulmns", name: "AddCoulmns", element: AddCoulmns },
  { path: "/fcoulmn", name: "FCoulmn", element: FCoulmn },
  { path: "/scoulmn", name: "SCoulmn", element: SCoulmn },
  { path: "/tcoulmn", name: "TCoulmn", element: TCoulmn },
];
