...
<div className="">
  ...
  <div className="col-md-6 d-flex flex-column justify-content-center align-items-center vh-100 position-relative">
      {showFirstSection && (
        <div className="border border-3 p-2 mb-2 w-50 d-flex justify-content-center position-absolute" style={{ top: '30%' }}>
